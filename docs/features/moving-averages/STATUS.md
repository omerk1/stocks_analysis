...
write-up drew — see `FINDINGS.md`'s Finding 2 entry for the full account. Every item
this file had flagged as open follow-up work is now closed; nothing further is
pending.
