...
Next up: M5, M6.2 — see `docs/backlog.md` for the remaining minimal-core modules, and
the saturation-watch note below before starting either on autopilot.
