...
Detects chart patterns (double top/bottom for now), upserts them into the
...
def main():
    parser = argparse.ArgumentParser(description="Detect chart patterns (double top/bottom, ...)")
