"""python -m src.signals.avwap.cli TICKER --timeframe daily|weekly|both [--as-of YYYY-MM-DD] [--plot out.html] [--include-stale]
...
from src.signals.avwap.models import AnchoredVwap, AnchorStatus, Timeframe
...
def main():
    ...
    raw_conn, derived_conn = derived_db.bootstrap_cli(store.create_avwap_table)
