"""python -m src.signals.patterns.cli TICKER --timeframe daily|weekly|both [--as-of YYYY-MM-DD] [--plot out.html]
...
from src.signals.patterns import store
from src.signals.patterns.config import get_preset
