"""python -m src.signals.sr_lines.cli TICKER [--preset ...] [--timeframe daily|weekly] [--as-of YYYY-MM-DD] [--out PATH]
python -m src.signals.sr_lines.cli --all [--preset ...] [--timeframe daily|weekly] [--as-of YYYY-MM-DD]
...
from src.signals.sr_lines import data as data_mod
from src.signals.sr_lines import engine
