...
from src.feature_engineering.volume_indicators import VolumeIndicators
...
def test_on_balance_volume_matches_hand_computed_sequence():
    ...
    result = VolumeIndicators.on_balance_volume(closes, volumes)
...
def test_money_flow_index_is_bounded_between_0_and_100():
    ...
    result = VolumeIndicators.money_flow_index(highs, lows, closes, volumes, timeperiod=14)
